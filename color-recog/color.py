...
while True:
    ...
    for cnt in contours_red:
        ...
        if contour_area > 1000:
            ...
            cv2.putText(img, 'Rojo', (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
    ...
    for cnt in contours_green:
        ...
        if contour_area > 1000:
            ...
            cv2.putText(img, 'Verde', (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 255, 0), 2)
    ...
    for cnt in contours_blue:
        ...
        if contour_area > 1000:
            ...
            cv2.putText(img, 'Azul', (x, y-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 0, 0), 2)
  
    cv2.imshow('Detección de colores', img)
